...
if ($_COOKIE['openid'] == null) {
    if (!isset($_GET['code'])) {
        ...
        $redirect_uri = urlencode('http://mooonhok-cloudware.daoapp.io/wx_my_consignment_note.php');
        $scope = 'snsapi_base';
        ...
        header('location:http://mooonhok-cloudware.daoapp.io/weixin/my_consignment_note.php');
    }
}else{
    header('location:http://mooonhok-cloudware.daoapp.io/weixin/my_consignment_note.php');
}
