...
if ($_COOKIE['openid'] == null) {
    if (!isset($_GET['code'])) {
        ...
        $redirect_uri = urlencode('http://mooonhok-cloudware.daoapp.io/wx_online_inquiry.php');
        $scope = 'snsapi_base';
        ...
        $num=rand(1,100);
        header('location:http://mooonhok-cloudware.daoapp.io/weixin/online_inquiry.html?num='.$num);
    }
}else{
	   $num=rand(1,100);
    header('location:http://mooonhok-cloudware.daoapp.io/weixin/online_inquiry.html?num='.$num);
